...
\subsection{Service Oriented Architecure (SOA)}
...
\begin{itemize}
\item Service provider, yaitu suatu entitas yang menyediakan interface terhadap sistem yang menjalankan suatu sekumpulan tugas tertentu.
\item Service requestor , yaitu suatu entitas yang meminta/memperoleh (dan menemukan) software service dalam rangka meyelesai kan suatu tugas tertentu atau menyediakan solusi bisnis tertentu.
\item Service registry , yaitu entitas yang bertindak sebagai penyimpan (repository) suatu software service yang dipublikasikan oleh Service provider\cite{hidayat2014penerapan}.
\end{itemize}
