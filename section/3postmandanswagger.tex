...
Selanjutnya, klik tautan atau impor Spekulan. Masukkan URL ke spanduk Swagger yang dihosting pada input teks atau pilih File untuk mengimpor file. Setiap kombinasi titik akhir metode dalam spesifikasi asisten akan membuat satu pengujian. Jika  memiliki banyak tes, hapus centang secara otomatis menjalankan kotak centang tes ini.
\end{enumerate}
\end{document}
