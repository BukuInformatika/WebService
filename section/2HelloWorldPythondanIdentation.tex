...
\begin{figure}[ht]
\centerline{\includegraphics[width=1\textwidth]{figures/2coding.JPG}}
...
Perhatikanlah bahwa pemanggilan nilai key yang tidak terdapat dalam dictionary akan menghasilkan nilai error\cite{herho2018tutorial}.
...
Satu lagi konsep penting dalam pemrograman Python yang harus kalian ingat adalah bahwa spasi dan indentasi mempunyai makna sintaktis. Spasi dan indentasi mendikte bagaimana kita mengeksekusi perintah. Tanda titik dua diperlukan untuk menandai subperintah sesudah perintah if, pada pengulangan (looping), atau sesudah pendefinisan fungsi. Dalam Python, seluruh subperintah yang satu kelompok sesudah tanda titik dua harus memilki indentasi yang sama, jika tidak maka akan menghasilkan error\cite{herho2018tutorial}. Untuk lebih jelasnya perhatikan contoh berikut ini:
