...
dan mengubahnya kedalam bentuk binary), Linker (Untuk menyatukan data binary yang dihasilkan compiler), Debuger (Untuk mengetes jalanya program
...
5.	KDevelop
6.	PyDev
7.	Wing IDE\cite{aripurnamayana2012rancangan}.
