...
%judul jurnal hari ke 2  IMPLEMENTASI REST WEB SERVICE UNTUK SALES ORDER DAN SALES TRACKING BERBASIS MOBILE
%judul jurnal hari ke 3  Penerapan Teknologi Web Service Untuk Integrasi Layanan Puskesmas dan Rumah Sakit
%judul jurnal hari ke 4  PEMANFAATAN GOOGLE MAPS API UNTUK PEMBANGUNAN SISTEM INFORMASI MANAJEMEN BANTUAN LOGISTIK PASCA BENCANA ALAM BERBASIS MOBILE WEB( Studi Kasus : Badan Penanggulangan Bencana Daerah Kota Yogyakarta ) 
%judul jurnal hari ke 5 WEB SERVICE SEBAGAI SOLUSI INTEGRASI DATA PADA SISTEM INFORMASI AKADEMIK UNIVERSITAS BINA DARMA
%judul hari ke 6 PERBANDINGAN ANTARA “BIG” WEB SERVICE DENGAN RESTFUL WEB SERVICE UNTUK INTEGRASI DATA BERFORMAT GML
