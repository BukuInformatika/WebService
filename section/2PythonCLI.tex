...
\end{enumerate}
Kami akan menggunakan modul argparse untuk menentukan pola argumen, menguraikan string, dan membuat objek dengan nilai argumen yang relevan. fitur dasar ini mencakup banyak alternatif pemrograman. server web, misalnya, dapat dianggap sebagai program CLI yang berjalan selamanya, melayani permintaan yang berasal dari nomor port tertentu. Aplikasi GUI mungkin mulai dari baris perintah, tetapi kemudian membuka jendela untuk memungkinkan interaksi pengguna.   \end{document} 