...
Kita akan melihat aplikasi CLI karena dua alasan. pertama, mereka bisa relatif sederhana, realying pada lebih sedikit paket atau kerangka kerja tambahan dari jenis aplikasi lain. kedua, aplikasi yang lebih kompleks akan sering diluncurkan dari skrip utama CLI. Untuk alasan ini, fitur CLI tampaknya sangat penting untuk sebagian besar penggunaan Python.\end{document}  